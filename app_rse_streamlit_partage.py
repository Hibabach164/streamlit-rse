...
with st.sidebar:
    ...
    st.code("https://app-rse-nylgmx6i8ay5fhqjqp4yuc.streamlit.app/")
    st.markdown(
        f"[🔗 Ouvrir dans un nouvel onglet](https://app-rse-nylgmx6i8ay5fhqjqp4yuc.streamlit.app/)",
        unsafe_allow_html=True
    )

# --- Chargement des données CSV ---
uploaded_file = st.file_uploader("📁 Importez votre fichier CSV ici", type=["csv"])
if uploaded_file:
    ...
    fig = px.bar(score_moy, x="Entreprise", y="Score", color="Score", color_continuous_scale="greens")
